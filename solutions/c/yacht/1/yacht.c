...
int score(dice_t dice, category_t category){
    int sum, final_score, psum, i, fh1, fh2;
    ...
    if (category==YACHT){
        ...
        for (i=0;i<5;i++){
            if (dice.faces[i]==1) psum=psum+dice.faces[i];
        }
        final_score=psum;
    }
        ...
        //calculate partial sum
        for (i=0;i<5;i++){
            if (dice.faces[i]==2) psum=psum+dice.faces[i];
        }
        final_score=psum;
    }
        ...
        //calculate partial sum
        for (i=0;i<5;i++){
            if (dice.faces[i]==3) psum=psum+dice.faces[i];
        }
        final_score=psum;
    }
        ...
        //calculate partial sum
        for (i=0;i<5;i++){
            if (dice.faces[i]==4) psum=psum+dice.faces[i];
        }
        final_score=psum;
    }
        ...
        //calculate partial sum
        for (i=0;i<5;i++){
            if (dice.faces[i]==5) psum=psum+dice.faces[i];
        }
        final_score=psum;
    }
        ...
        //calculate partial sum
        for (i=0;i<5;i++){
            if (dice.faces[i]==6) psum=psum+dice.faces[i];
        }
        final_score=psum;
    }
