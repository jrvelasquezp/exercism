...
Iteration : 02
Notes
This version is a refactor from the first iteration submitted. Some objectives are:
-Make a proper allocation memory.
-Remove redundant variables.
-Try to implement ternary if-else.
*/
...
char *translate(const char *phrase){
    const char delim[2]=" ";
    char *pig_answer=(char *)malloc(50);
    char *pig_answer_2=(char *)malloc(50);
    char *token;
    strcpy(pig_answer,phrase);
    strcpy(pig_answer_2,"");
