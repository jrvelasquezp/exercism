...
namespace estate_executor{
    ...
    int assemble_code() {
        int red_fragment, blue_fragment;
        red_fragment=zhang::red::code_fragment()+khan::red::code_fragment()+garcia::red::code_fragment();
        blue_fragment=zhang::blue::code_fragment()+khan::blue::code_fragment()+garcia::blue::code_fragment();
